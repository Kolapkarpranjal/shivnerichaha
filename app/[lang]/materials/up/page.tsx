...
const materialsData: MaterialCategory[] = [
  ...
  },
  {
    ...
    showItemCosts: false,
    overrideTotal: 85000, // Uttar Pradesh specific price - can be updated later
  },
  {
  ...
  },
  {
    ...
    showItemCosts: false,
    overrideTotal: 35000, // Uttar Pradesh specific price - can be updated later
  },
];

export default function UttarPradeshMaterialsPage() {
    ...
    <div className="bg-gray-50">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            🛠 Materials & Equipment - Uttar Pradesh
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Explore all the essential equipment and materials required for your Shivneri Chaha setup in Uttar Pradesh
          </motion.p>
        </div>
      </section>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-2xl shadow-lg p-12 text-center mb-12">
          ...
          <h3 className="text-3xl md:text-4xl font-extrabold">Total Investment - Uttar Pradesh</h3>
        ...
        <div className="bg-yellow-100 border-l-8 border-yellow-500 rounded-xl shadow p-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-yellow-800">Important Instructions for Uttar Pradesh</h3>
          </div>
          <ul className="space-y-3 text-gray-700 leading-relaxed">
            ...
            <li>Shivneri Board : ₹35,000 (Company will fit them, but ensure your shop shed/structure is ready).</li>
            ...
            <li className="font-semibold text-indigo-700">Uttar Pradesh specific: Verify local trade license requirements for food business.</li>
          </ul>
        </div>
      </main>
