    ...
    <div className="bg-gray-50">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            Explore all the essential equipment and materials required for your Shivneri Chaha setup
          </motion.p>
        </div>
      </section>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="bg-yellow-100 border-l-8 border-yellow-500 rounded-xl shadow p-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-yellow-800">Important Instructions</h3>
          </div>
